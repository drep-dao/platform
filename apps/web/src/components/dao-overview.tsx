...
// Column-sort indicator: a clean chevron pair. Both chevrons show faint when the column isn't the
// active sort; the active direction's chevron is emphasized and the other dims.
